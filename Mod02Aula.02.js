...
//ALTERAR A FORMA COMO USA A BIBLIOTECA
import readline from "readline-sync" //UTILIZANDO O IMPORT ao invés de const
...
console.log("============================");
    ...
    switch (opcao) {
        case 1:
            ...
            console.log("==================================");
            readline.keyInPause(); // AGUARDA UM CLIQUE PARA CONTINUAR
            break;
        case 2:
